...
import { adminOrderStatusUpdate, getAdminOrder, messageClear } from "../../store/reducers/orderReducer";
...
export default function OrderDetails() {
  ...
  const statusUpdate = (e) => {
    dispatch(adminOrderStatusUpdate({ orderId, info: { status: e.target.value } }));
            ...
            <div className='w-[30%]'>
              <div className='pr-3 text-[#d0d2d6] text-lg'>
                <div className='flex flex-col gap-1'>
                  <h2 className='pb-2 font-semibold'>Deliver {order.shippingInfo?.name}</h2>
                  <p>
